          ...
          >
            ...
            <div class="p-4 space-y-3 w-full">
              ...
              <div class="flex justify-between items-center w-full">
                ...
                <p
                  class="${
                    element.priority=== "high" ? "text-error" : element.priority === "medium" ? "text-[#F59E0B]" : "text-[#9CA3AF]"
                  } py-[6px] text-xs w-[80px] uppercase text-center rounded-full ${
                    element.priority=== "high" ? "bg-[#FEECEC]" : element.priority === "medium" ? "bg-[#FFF6D1]" : "bg-[#EEEFF2]"
                  }"
                >
                  ${element.priority}
                </p>
